    ...
    <div className="min-h-screen bg-zinc-50">
      <header className="bg-white border-b border-zinc-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-xl font-semibold text-zinc-900">Team CRM</h1>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="bg-white rounded-xl border border-zinc-200 p-12 text-center">
          ...
          <h2 className="text-lg font-semibold text-zinc-900 mb-2">Team Management</h2>
          <p className="text-sm text-zinc-500 mb-6 max-w-md mx-auto">
            Track team performance, manage contractors, and monitor project health scores.
          </p>
